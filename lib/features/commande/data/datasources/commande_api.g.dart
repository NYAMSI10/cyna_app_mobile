...
class _CommandeApi implements CommandeApi {
  _CommandeApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<ApiResponse<CreateCommandeResponse>> createCommande(
    ...
    _data.addAll(body);
    final _options = _setStreamType<ApiResponse<CreateCommandeResponse>>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<CreateCommandeResponse> _value;
    try {
      _value = ApiResponse<CreateCommandeResponse>.fromJson(
        _result.data!,
        (json) => CreateCommandeResponse.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
