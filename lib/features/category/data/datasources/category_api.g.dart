...
class _CategoryApi implements CategoryApi {
  ...
  Future<ApiResponse<List<CategoryResponse>>> getCategoriesByOrder() async {
    ...
    final _options = _setStreamType<ApiResponse<List<CategoryResponse>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/categories/category-by-order',
  ...
  Future<ApiResponse<CategoryDetailResponse>> getCategoryBySlug(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<CategoryDetailResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<CategoryDetailResponse> _value;
    try {
      _value = ApiResponse<CategoryDetailResponse>.fromJson(
        _result.data!,
        (json) => CategoryDetailResponse.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
